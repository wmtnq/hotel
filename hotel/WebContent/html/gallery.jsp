...
<body>
							...
							<div class="collapse navbar-collapse navbar-right"
								...
								<nav class="link-effect-12">
									<ul class="nav navbar-nav w3_agile_nav">
										...
										<li class="active"><a href="gallery.jsp"><span>画廊</span></a></li>
										<li><a href="about.jsp"><span>关于我们</span></a></li>
										<li><a href="typography.jsp"><span>预定</span></a></li>
		...
		<div class="container">
			...
			<div class="gallery-grids">
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-apollo">
							<a class="example-image-link" href="images/9.jpg"
								data-lightbox="example-set"
								data-title="征启一角.">
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-apollo">
							<a class="example-image-link" href="images/12.jpg"
								data-lightbox="example-set"
								data-title="征启一角.">
				...
				<div class="col-md-4 gallery-grid">
					<div class="grid">
						<figure class="effect-apollo">
							<a class="example-image-link" href="images/13.jpg"
								data-lightbox="example-set"
								data-title="征启一角.">
	...
	<div class="w3-agile-footer">
		...
		<ul class="mengnan">
			...
			<li>St Dolore Place,Kingsport 56777.</li>
			<li>Phone : +1 123 456 789</li>
			<li>Email : <a href="mailto:example@email.com">mail@example.com</a></li>
		</ul>
		<ul class="mengnan">
