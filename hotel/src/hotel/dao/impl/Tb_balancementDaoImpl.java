...
public class Tb_balancementDaoImpl extends BaseDaoDBUtil<Tb_balancement> implements Tb_balancementDao {
	...
	public int addTb_balancement(Tb_balancement tb_balancement) {
		...
		int id = (int) super.executeUpdata(prepardSql, tb_balancement.getBm_id(), tb_balancement.getBm_checkinorderId(),
				tb_balancement.getBm_roomId(), tb_balancement.getBm_guestId(), tb_balancement.getBm_paymentmodel(),
