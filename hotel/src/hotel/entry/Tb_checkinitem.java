...
public class Tb_checkinitem {
	...
	private String cim_name;// 姓名
	private String cim_cardId; // 身份证号
	private String cim_phone;// 手机号
	...
	public String getCim_cardId() {
		return cim_cardId;
	}

	public void setCim_cardId(String cim_cardId) {
		this.cim_cardId = cim_cardId;
	}

	public String getCim_phone() {
		return cim_phone;
	}

	public void setCim_phone(String cim_phone) {
		this.cim_phone = cim_phone;
	}
